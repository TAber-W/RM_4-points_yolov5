...
def build_targets(p, targets, model):
    ...
    gain = torch.ones(15, device=targets.device) #change_6
    ...
    for i in range(det.nl):
        ...
        #landmarks 10
        gain[6:14] = torch.tensor(p[i].shape)[[3, 2, 3, 2, 3, 2, 3, 2]]  # xyxy gain #change_7
        ...
        # Append 
        a = t[:, 14].long()  # anchor indices #change_8
